<%-- 
    Document   : VerPedidos
    Created on : 5/12/2010, 07:26:51 PM
    Author     : Pepe
--%>
...
<html>
    <head>
        ...
        <title>Libros.com | Rebizar Pedidos</title>
        <!--Styles-->
                ...
                <div id="wrapper2">
                    ...
                    <div class="panel_busqueda">
                        <c:if test="${requestScope.operacionFallida == 'NO'}">
                            ...
                            <br>
                            <center>
                                <h2><b>Escoja de la lista de pedidos el que desee consultar.</b><br></h2>
