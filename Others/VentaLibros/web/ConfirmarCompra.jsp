<%-- 
    ...
    Created on : 5/12/2010, 06:29:15 PM
    Author     : Pepe
--%>
...
<html>
    <head>
        ...
        <title>Libreria.com |   Confirmar Compra</title>
            ...
            <div id="main">
                ...
                <div id="wrapper2">
                    ...
                    <div class="panel_busqueda">
                        <br><h1>Confirmenos su compra, Confirme su usuario</h1>
                        <br>
                        <center>
                            <table border="0">
                                <font face="bold" size="12">
                                    ...
                                    <tr>
                                        <td align="right" colspan = 2><input align='center' type='submit' name='boton' value='Confirmar'></td>
                                    </tr>                                    
                                </font>
                            </table>
                        </center>
