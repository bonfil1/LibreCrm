<%-- 
    ...
    Created on : 5/12/2010, 11:09:08 AM
    Author     : Pepe
--%>
...
<html>
    <head>
        ...
        <title>Libros.com | Resultado de su busqueda</title>
        <!--Styles-->
                ...
                <div id="main">
                    ...
                    <div id="wrapper2">
                        ...
                        <div class="panel_busqueda">
                            ...
                            <table width=100% cellspacing="0" cellpadding="0" border="0">
                                <tr bgcolor="#000000">
                                    <td colspan=100% align="right">
                                        ...
                                        <input type="submit" name="boton" value="Ver Carrito">
                                    </td>
                                </tr>
                                <tr bgcolor="#000000">
                                    <td colspan=100% align="right"><font face="Verdana,Helvetica" size="2"
                                                                         color="#FFFFFF"><b>
                                                Total:&nbsp;&nbsp;&nbsp;
                            ...
                            <%-- Creamos nuestra tabla para poder mostrar resultados--%>
                            <table width=100% cellspacing="0" cellpadding="0" border="0">
                                <%--
                                ...
                                <tr bgcolor="#ccffcf">
                                    <td colspan=100% height="20">
                                        <font face="Verdana,Helvetica" size="3" color="#000000"><b>Libros</b> </font></td>
                                </tr>
                                <tr bgcolor="#ccffcc">
                                    <td width="5%">
                                ...
                                <c:forEach var="fila" items="${requestScope.librosDisponibles}">
                                    <tr>
