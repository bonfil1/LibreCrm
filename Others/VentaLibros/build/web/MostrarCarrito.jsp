<%-- 
    ...
    Created on : 5/12/2010, 06:13:26 PM
    Author     : Pepe
--%>
...
<html>
    <head>
        ...
        <title>Libreria.com |   Carrito</title>
                ...
                <div id="main">
                    ...
                    <div id="wrapper2">
                        ...
                        <font face="Verdana,Helvetica" size="2" color="#000000">
                            <table bgColor="#ccffcf" border="0" cellPadding="0" cellspacing=4 width=355 nowrap>
                                <tr>
                                    <td>ID:</td>
                                    <td>${sessionScope.id_user}</td>                                    
                                </tr>
                                <tr>
                                    <td>Nombre:</td>
                                ...
                                <tr>
                                    <td>Seleccione su forma de pago</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name='numTarjeta' size='16' value='0'></td>
                                </tr>
                                <tr>
                                    <td align="right"><input type="submit" name="boton" value="Aceptar"></td>
                                </tr>
                            </table>
                        </font>
                        <br>
