...
public class Actividades implements Comparator{
    ...
    public Actividades(){}
    public Actividades(int id, String name,String rfc,String description,
    ...
    public int compare(Object o1, Object o2) {
        if (((Actividades) o1).id < ((Actividades) o2).id) {
            return -1;
        } else if (((Actividades) o1).id == ((Actividades) o2).id) {
            return 1;
        } else {
            return 1;
        }
