...
<html>
    <head>
        ...
        <title>LibreCrm | Oportunidades</title>
        <!--Styles-->
    ...
    <body>
        <form action="/LibreCrm/SvLibreCrm" method="POST">
            <div id="wrapper">
                ...
                <div id="cabezera">
                    <div id="header2">Lista de Oportunidades</div>
                    <div id="opciones">
                                    ...
                                    <div id="cuentas">
                                        <div id="cuentas_layout">
                                            <table border="0" width="100%" class="flexme">
                                                ...
                                                --%>
                                                <tbody>
                                                    <c:forEach var="fila" items="${requestScope.listaOportunidades}">
                                                        <tr>
                                                            <td>${fila.first_name} ${fila.last_name}</td>
                                                            <td>${fila.user_name}</td>
                                                            <td>${fila.date_entered}</td>
                                                            <td>${fila.description}</td>
                                                            <td><a href="/LibreCrm/SvLibreCrm?tipo=cuentas&id=${fila.id}&accion=editar">Editar</a> </td>
                                                            <td><a href="/LibreCrm/SvLibreCrm?tipo=cuentas&id=${fila.id}&accion=eliminar">Eliminar</a> </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
