    ...
    <body>
        ...
        <form action="/LibreCrm/SvLibreCrm" method="POST">
            <div id="wrapper">
                ...
                <div id="cabezera">
                    <div id="header2">Lista de Cuentas</div>
                    <div id="opciones">
                                    ...
                                    <div id="cuentas">
                                        <div id="cuentas_layout">
                                            <table border="0" width="100%" class="flexme">
                                                ...
                                                --%>
                                                <tbody>
                                                    <c:forEach var="fila" items="${requestScope.listaCuentas}">
                                                        <tr>
                                                            <td>${fila.name}</td>
                                                            <td>${fila.first_name} ${fila.last_name}</td>
                                                            <td>${fila.date_entered}</td>
                                                            <td>${fila.description}</td>
                                                            <td><a href="/LibreCrm/SvLibreCrm?link=cuentasEdit&id=${fila.id}">Editar</a> </td>
                                                            <td><a href="/LibreCrm/SvLibreCrm?link=cuentasElim&id=${fila.id}">Eliminar</a> </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
